...
export const metadata: Metadata = {
    ...
    description: 'Automate customer service on Instagram, WhatsApp & website chat with ChatAgent\'s AI assistant. Instant replies, smart conversations, 14-day free trial.',
