            ...
            <div className={styles.heroSection}>
                <div className={styles.heroContent}>
                    ...
                    <div className={styles.heroDescription}>
                        <p>
                            This Privacy Policy explains how INSTAREPLY W.L.L.
                            (&quot;InstaReply,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) collects, uses,
                            discloses, and protects personal information in connection with the Chat Agent service and
                            related websites, dashboards, APIs, plugins, and support channels (collectively,
                            the &quot;Service&quot;).
                        </p>
                    </div>
                    ...
                    <div className={styles.heroSubDescription}>
                        <p>
                            This document is intended to be globally compliant, including with the EU/UK GDPR, the
                            California Consumer Privacy Act as amended by the CPRA (CCPA), and the Bahrain Personal Data
                            Protection Law (Law No. 30 of 2018) (Bahrain PDPL). Where local law imposes stricter
                            requirements, we will comply with those requirements.
                        </p>
                    </div>
                </div>
            </div>
