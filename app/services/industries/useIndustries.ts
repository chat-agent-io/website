...
const INDUSTRY_CATEGORY_QUERY_KEY = (slug: string) =>
  ["industry-category", slug] as const;
...
export const useIndustryCategoryBySlug = (
  slug: string
): UseQueryResult<IndustryCategoriesResponse, Error> => {
  return useQuery({
